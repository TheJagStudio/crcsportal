...
const Footer = () => {
	return (
		<section className="py-10 bg-gradient-to-b from-primary-500 via-primary-600 to-primary-700 sm:pt-16 lg:pt-14">
			<div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
				...
				<div className="flex flex-wrap items-center justify-between">
					...
					<p className="w-full mt-8 text-sm text-center text-primary-100 md:mt-0 md:w-auto md:order-2">
						© Copyright 2021, All Rights Reserved by <b>Dreamers</b>
					</p>
				</div>
			</div>
		</section>
