...
const AdminSidebar = () => {
	return (
		<div className="fixed top-0 left-0 bg-primary-500 h-screen px-2 z-50 shadow-xl">
			<div className="flex h-full w-full flex-col items-center dark:border-navy-700 dark:bg-navy-800">
				...
				<div className="is-scrollbar-hidden flex grow flex-col space-y-4 overflow-y-auto pt-6">
					<a href="#" className="flex h-11 w-11 items-center justify-center rounded-lg bg-white text-primary outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:bg-navy-600 dark:text-accent-light dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90" >
						<svg className="h-7 w-7 text-black group-hover:text-primary-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
