...
const AdminSidebar = () => {
	return (
		<div className="fixed top-0 left-0 bg-primary-500 h-screen max-w-[5vw] px-2 z-50 shadow-xl overflow-hidden transition-all duration-300" id='sidebarContainer'>
			<div className="flex h-full w-full flex-col dark:border-navy-700 dark:bg-navy-800">
				<div className="flex pt-4">
					<a href="/">
						<img className="h-11 w-11 transition-transform duration-500 ease-in-out hover:rotate-[360deg] hover:rotate-180" src="/logo.png" alt="logo" />
					</a>
				</div>

				<div className="is-scrollbar-hidden flex grow flex-col space-y-4 overflow-y-auto pt-6">
					<div className='flex items-center gap-5 w-fit'>
						<a href="#" className="flex h-11 min-w-11 w-11 items-center justify-center rounded-lg bg-white text-primary outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:bg-navy-600 dark:text-accent-light dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90" >
							<svg className="h-7 min-w-7 w-7 text-black group-hover:text-primary-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
						...
						<p className='p-1.5 px-4 bg-white text-primary-500 rounded-lg'>Home</p>
					</div>

					<a href="#" className="flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors group bg-primary-200 group-hover:bg-white duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25" >
