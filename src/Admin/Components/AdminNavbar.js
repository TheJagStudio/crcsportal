					...
					<div className="flex w-full items-center justify-between">
						...
						<div className="-mr-1.5 flex items-center space-x-2">
							...
							<div className="flex">
								<div className="relative mr-4 flex h-8">
									<input
										...
										className="form-input peer h-full rounded-full px-4 pl-9 text-xs+ bg-transparent border-2 border-primary-700 text-white w-60 placeholder:text-white"
										type="text"
									/>
									<div className="pointer-events-none absolute flex h-full w-10 items-center justify-center text-white">
										<svg
											xmlns="http://www.w3.org/2000/svg"
							...
							<button className="btn h-8 w-8 rounded-full p-0 bg-white flex items-center justify-center">
								<svg
									className="h-6 w-6 text-amber-400 hidden"
									fill="currentColor"
									viewBox="0 0 24 24"
								>
