...
const AdminUserList = () => {
	...
	function editAction(i) {
		...
		let name = currentDiv.parentElement.parentElement.parentElement.children[1].innerHTML;
			...
			<div id="mainContainer" className="pl-[6%] pt-[5rem] p-4 transition-all duration-300 bg-primary-100">
				<div className="p-4 w-[80%] mx-auto">
					<ul className="grid grid-cols-2 w-[40%] text-center overflow-hidden">
						<TabNavItem title="User Form" id="tab1" activeTab={activeTab} setActiveTab={setActiveTab} />
					...
					<div>
						<TabContent id="tab1" activeTab={activeTab}>
							<div className="border-2 border-primary-800 bg-white p-4 w-full rounded-lg rounded-tl-none">
									...
									<div className="w-full relative">
										...
										<span className="relative">
											<span className="pointer-events-none absolute left-2 top-0 flex  items-center justify-center text-primary-700 peer-focus:text-primary">
												<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" height={20} width={20} viewBox="0 0 448 512">
													<path d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512H418.3c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304H178.3z" />
												</svg>
											</span>
											<input type="text" placeholder="Name" data-title="userName" className="my-3 form-input outline-none peer w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 pl-9 placeholder:font-light hover:border-primary-700 focus:border-primary" />
										</span>
									</div>
								</div>
								...
								<div className="grid grid-cols-2 gap-5 my-3 mb-5">
									<div className="w-full">
										...
										<span className="relative">
											...
											<input type="date" placeholder="DD/MM/YYYY" data-title="userDate" className="my-3 form-input outline-none peer w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 pl-9 placeholder:font-light hover:border-primary-700 focus:border-primary" />
										</span>
									</div>
									<div className="w-full">
										<p className="text-black">Select Society Type</p>
										<span className="relative flex">
											<select data-title="userType" id="userType" className="my-3 form-input outline-none peer w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 pl-9 placeholder:font-light hover:border-primary-700 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent">
												<option selected disabled>
													--Select Type--
												</option>
						...
						<TabContent id="tab2" activeTab={activeTab}>
							<div className="border-2 border-primary-800 bg-gradient-to-br from-primary-200 to-primary-500 p-4 w-full rounded-lg">
								<Table editAction={editAction} deleteAction={deleteAction} rowLimit={25} link={process.env.REACT_APP_SERVER + "/api/registered-user/"} admin={true} columns={["Sr No", "Name", "State", "District", "Society Type", "User Reg. Date", "Action"]} classes={"p-4 py-3 w-full mx-auto mt-5 overflow-x-scroll noScrollBar"} />
							</div>
						</TabContent>
					</div>
				</div>
