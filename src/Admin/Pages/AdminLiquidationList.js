...
const AdminLiquidationList = () => {
	...
	function editAction(i) {
		...
		let nameliquidation = currentDiv.parentElement.parentElement.parentElement.children[1].innerHTML;
		let state = currentDiv.parentElement.parentElement.parentElement.children[2].innerHTML;
		let nameOfLiquidator = currentDiv.parentElement.parentElement.parentElement.children[3].innerHTML;
		let appointmentDate = currentDiv.parentElement.parentElement.parentElement.children[4].innerHTML;
		let validityDate = currentDiv.parentElement.parentElement.parentElement.children[5].innerHTML;
		let status = currentDiv.parentElement.parentElement.parentElement.children[6].innerHTML;
		localStorage.setItem("liquidationNameSociety", nameliquidation);
		localStorage.setItem("liquidationNameLiquidator", nameOfLiquidator);
		localStorage.setItem("liquidationState", state);
		localStorage.setItem("liquidationReceivedDate", appointmentDate);
		localStorage.setItem("liquidationDisposalDate", validityDate);
		localStorage.setItem("liquidationStatus", status);
		...
		<>
			...
			<div id="mainContainer" className="pl-[6%] pt-[5rem] p-4 transition-all duration-300 bg-primary-100">
				<div className="p-4 w-[80%] mx-auto">
					<ul className="grid grid-cols-2 w-[45%] text-center overflow-hidden">
						<TabNavItem title="Liquidation Form" id="tab1" activeTab={activeTab} setActiveTab={setActiveTab} />
					...
					<div>
						<TabContent id="tab1" activeTab={activeTab}>
							<div className="border-2 border-primary-800 bg-white p-4 w-full rounded-lg rounded-tl-none">
								...
								<div className="grid grid-cols-2 gap-5 mt-3">
									<div className="w-full relative">
										...
										<span className="relative">
											...
											<input type="text" placeholder="Name of society" data-title="liquidationNameSociety" className="my-3 form-input outline-none peer w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 pl-9 placeholder:font-light hover:border-primary-700 focus:border-primary" />
										</span>
									</div>
									<div className="w-full relative">
										<p className="text-black">Enter Name Of The Liquidator</p>
										<span className="relative">
											<span className="pointer-events-none absolute left-2 bottom-0.5 flex  items-center justify-center text-primary-700 peer-focus:text-primary">
												<svg width={20} height={20} fill="currentColor" viewBox="0 0 50 50" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
													<path d="M12 3.6132812L12 28L9 28L9 23L7 23L7 28L4 28L4 46L21 46L35 46L46 46L46 15L35 15L35 11.279297L32 10.279297L32 4L30 4L30 9.6113281L28 8.9453125L28 4L26 4L26 8.2792969L12 3.6132812 z M 14 6.3886719L33 12.720703L33 44L28 44L28 40.855469C29.715786 40.405591 31 38.850301 31 37C31 34.802706 29.197294 33 27 33C24.802706 33 23 34.802706 23 37C23 38.850301 24.284214 40.405591 26 40.855469L26 44L21 44L21 28L14 28L14 6.3886719 z M 16 12L16 14L22 14L22 12L16 12 z M 16 16L16 18L31 18L31 16L16 16 z M 37 19L42 19L42 22L37 22L37 19 z M 16 20L16 22L24 22L24 20L16 20 z M 26 20L26 22L31 22L31 20L26 20 z M 16 24L16 26L31 26L31 24L16 24 z M 37 24L42 24L42 27L37 27L37 24 z M 23 28L23 30L31 30L31 28L23 28 z M 37 29L42 29L42 32L37 32L37 29 z M 8 32L11 32L11 34L8 34L8 32 z M 14 32L17 32L17 34L14 34L14 32 z M 37 34L42 34L42 37L37 37L37 34 z M 8 36L11 36L11 38L8 38L8 36 z M 14 36L17 36L17 38L14 38L14 36 z M 37 39L42 39L42 42L37 42L37 39 z M 8 40L11 40L11 42L8 42L8 40 z M 14 40L17 40L17 42L14 42L14 40 z" />
											...
											<input type="text" placeholder="Name of Liquidator" data-title="liquidationNameLiquidator" className="my-3 form-input outline-none peer w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 pl-9 placeholder:font-light hover:border-primary-700 focus:border-primary" />
										</span>
									</div>
								</div>
								...
								<div className="grid grid-cols-3 gap-5 my-3 mb-5">
									<div className="w-full">
										<p className="text-black">Enter Date of Appointment Order</p>
										<span className="relative">
											...
											<input type="date" placeholder="DD/MM/YYYY" data-title="liquidationReceivedDate" className="my-3 form-input outline-none peer w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 pl-9 placeholder:font-light hover:border-primary-700 focus:border-primary" />
										</span>
									</div>
									<div className="w-full">
										<p className="text-black">Enter Liquidation Validity Date</p>
										<span className="relative">
											<span className="pointer-events-none absolute left-2 top-0 flex  items-center justify-center text-primary-700 peer-focus:text-primary">
												<svg fill="currentColor" width={20} height={20} viewBox="0 0 36 36" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
													<title>{"date-line"}</title>
											...
											<input type="date" placeholder="DD/MM/YYYY" data-title="liquidationDisposalDate" className="my-3 form-input outline-none peer w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 pl-9 placeholder:font-light hover:border-primary-700 focus:border-primary" />
										</span>
									</div>
									<div className="w-full">
										<p className="text-black">Select Status</p>
										<span className="relative flex">
											<select data-title="liquidationStatus" id="liquidationStatus" className="my-3 form-input outline-none peer w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 pl-9 placeholder:font-light hover:border-primary-700 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent">
												<option selected disabled>
													--Select Status--
												</option>
						...
						<TabContent id="tab2" activeTab={activeTab}>
							<div className="border-2 border-primary-800 bg-gradient-to-br from-primary-200 to-primary-500 p-4 w-full rounded-lg">
								<Table editAction={editAction} deleteAction={deleteAction} rowLimit={25} link={process.env.REACT_APP_SERVER + "/api/liquidation-list/"} admin={true} columns={["S No", "Name of Society", "State", "Name Of Liquidator", "Date of Appointment Order", "Liquidation Validity Date", "Status", "Action"]} classes={"p-4 py-3 w-full mx-auto mt-5 overflow-x-scroll noScrollBar"} />
							</div>
						</TabContent>
					</div>
				</div>
