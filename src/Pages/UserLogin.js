...
const UserLogin = () => {
	...
	return (
		<section className="w-full relative min-h-screen p-0 lg:p-10 flex items-center justify-between bg-gradient-to-tl from-secondary-400 to-secondary-100">
			...
			<form className="w-full lg:w-[50%] h-screen lg:h-auto mx-auto border-2 border-secondary-700 bg-white backdrop-blur-xl rounded-none lg:rounded-xl overflow-hidden">
				...
				<div className="px-12 py-6">
					<div className="mt-4 space-y-4">
						...
						<div className="grid grid-cols-1 gap-4 sm:grid-cols-2 place-center">
							<img src={"data:image/png;base64," + captchaImage} alt="" className="w-full h-[80%] object-contain mix-blend-hard-light" />
							<label className="block text-sm">
								<span>Captcha</span>
								<span className="relative mt-1.5 flex">
